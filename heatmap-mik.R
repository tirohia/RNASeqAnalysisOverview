heatmap.mik<-function (x, Rowv = TRUE, Colv = if (symm) "Rowv" else TRUE,
    ...
    add.expr, breaks, col = "heat.colors", 
    colsep,
    rowsep, 
    sepcolor = "white", 
    ...
    ...)
{
    ...
    if (!missing(breaks) && (scale != "none"))
        warning("Using scale=\"row\" or scale=\"column\" when breaks are","specified can produce unpredictable results.", "Please consider using only one or the other.")
